...
public class EquipeMandante {
    ...
    public EquipeMandante() {
	super();
    }

    public EquipeMandante(long equipe_id, String nome, String nome_popular, String sigla, String genero, Escudo escudos, Cor cores,
	    String slug) {
	super();
	...
	if (getClass() != obj.getClass())
	    return false;
	EquipeMandante other = (EquipeMandante) obj;
	if (cores == null) {
	    if (other.cores != null)
		return false;
	...
	return "EquipeMandante [equipe_id=" + equipe_id + ", nome=" + nome + ", nome_popular=" + nome_popular + ", sigla=" + sigla
